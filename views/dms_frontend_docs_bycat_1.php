        ...
        <table cellspacing="1" cellpadding="3" class="ui-widget-content" width="100%">
            <tr>
                ...
                <td class="ui-widget-content" colspan="3">
                    <?php echo str_replace("-"," ",$section_name);?>
                    <input type="hidden" name="SECTION_ID" id="SECTION_ID" readonly value="<?php echo $section_id;?>">
	   ...
	   <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
		...
		<?php   
            ...
            <tr>
                ...
                |<a  target="_blank" href="<?php echo base_url().$doc["FILE_PATH"];?>" class="data-img row-icon" download="<?php echo str_replace("dms_uploads","",$doc["FILE_PATH"]);?>"><i class="fa fa-download"></i> Download</a></td>
            </tr>
