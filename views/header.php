    ...
    <header class="site-navbar js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container">
        <div class="row align-items-center position-relative">
          <div class="col-12">
            <a href="<?php echo base_url(); ?>dms/Dms_frontend_c"><img src="<?php echo base_url(); ?>/assets/images/dms_logo.png" title="Document Management System - CG WRD" height="95px" alt="DMS CGWRD"></a>
            <div class="float-right"><a href=""><img src="<?php echo base_url(); ?>/assets/images/wrdlogo89x94.png" alt="CG WRD" title="CG WRD" height="95px"></a></div>
