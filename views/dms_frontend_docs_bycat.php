...
<h2 class="dm_title"><img class="wi" src="<?php echo base_url();?>assets/folder.png" alt="Archive" class="s5_lazyload" style="opacity: 1;"><?php if(!empty($category_name)){?><a href="<?php echo base_url().'cat_view/'.$baseroroot["SLUG"].'/'.$category_root["SLUG"];?>"><?php echo ucfirst($category_name);?></a>/ <?php } //echo ucfirst($category_cat['CATEGORY_ENG']);?></h2>
<div>
